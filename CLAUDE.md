...
4. Liquidación de lavadores: sobre acumulado — admin puede generar la liquidación diaria o semanal para cualquier lavador (decisión manual en cada generación, sin bandera de excepción persistida por lavador). **Actualizada 2026-09-14**: SÍ hay descuentos — préstamos en efectivo y consumo de nevera cargado a su nombre se descuentan de la próxima liquidación (ver "Deuda de lavadores" en `docs/historial-tecnico.md`). Si la deuda supera la comisión de ese corte, la liquidación queda en $0 y el resto de deuda sigue pendiente — nunca se genera un monto negativo.
...
- **Deuda de lavadores**: préstamos en efectivo y consumo de nevera cargados a nombre de un lavador, descontados de su próxima liquidación (nunca deja el monto en negativo).
- **Colilla del día**: corte informativo (no genera liquidación real) para que un lavador vea cómo va en el día, disponible desde admin y desde jefe de zona.
...
- **Conteo de inventario en apertura y cierre de turno** (solo jefe de zona): cuadre de PRODUCTO en paralelo al arqueo de efectivo, mismo patrón ciego → revelar → justificar. Faltante valorado a costo, invisible para jefe de zona.
...
- **Toda la operación diaria la hace el jefe de patio sin PIN** — recepción, cobro (con o sin descuento), cortesías, anulación de órdenes (cobradas o no), corrección de órdenes, ventas, cuentas, parqueadero, apertura/cierre de turno y arqueo, gastos de caja, movimientos de inventario. Todo.
