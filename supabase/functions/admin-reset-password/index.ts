...
// El navegador hace un preflight OPTIONS antes del POST (el header Authorization lo obliga). Sin
// estos headers y sin responder al OPTIONS, el preflight falla y el POST nunca sale.
const corsHeaders = {
